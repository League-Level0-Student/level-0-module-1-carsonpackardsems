...
public class DudeFight {
	...
	String attackMethodP1 =	JOptionPane.showInputDialog("Player 1, Do you want to use your Sword,Bow, or Flame Burst Inferno to attack?  Or would you rather use Taunt or Disarm?");
	String attackMethodP2 =	JOptionPane.showInputDialog("Player 2, Do you want to use your Sword,Bow, or Flame Burst Inferno to attack?  Or would you rather use Taunt or Disarm?");
		...
		if (attackMethodP1.equalsIgnoreCase("Taunt")) {
			playerMagicAttack = playerMagicAttack - 10;
			playerRangedAttack = playerRangedAttack - 10;
			IQ = IQ - IQ;
		}
		if (attackMethodP2.equalsIgnoreCase("Disarm")) {
			playerMeleeAttack = playerMeleeAttack - 20;
		}
		if (playerHealth1 <= 0) {
